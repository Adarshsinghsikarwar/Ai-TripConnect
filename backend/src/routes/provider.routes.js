...
import { createProviderValidator, searchProviderValidator } from '../validators/provider.validator.js';
import { registerProvider, getProvider, searchProviders, smartSearch, updateProvider, uploadPhotos, setVerification } from '../controllers/provider.controller.js';

const router = express.Router();

router.get('/search', searchProviderValidator, validate, searchProviders); // public
router.get('/search/smart', smartSearch); // public — natural language search
