...
function sendTokenResponse(res, { accessToken, refreshToken, userId }, message, status = 200) {
  res
...
export { register, login, googleCallback, refresh, logout };
export default { register, login, googleCallback, refresh, logout };